<script lang="ts">
	...
	let { title = 'Project Miru', children }: Props = $props();
</script>
...
>
	...
	<div class="flex h-16 w-16 items-center justify-center justify-self-center">
		<!-- logo slot — compass + fruit will be ported in a later phase -->
	</div>
