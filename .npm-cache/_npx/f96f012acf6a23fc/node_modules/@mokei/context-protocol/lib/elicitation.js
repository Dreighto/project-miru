...
export const elicitRequestURLParams = {
    properties: {
        elicitationId: {
            description: 'A unique identifier for this elicitation request, scoped to the server. This is opaque to the client.',
            type: 'string'
        },
        message: {
            description: 'The message explaining why the user should navigate to the URL and what they should do there.',
            type: 'string'
        },
        mode: {
            const: 'url',
