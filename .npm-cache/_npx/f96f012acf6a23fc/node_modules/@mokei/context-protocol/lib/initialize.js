    ...
    properties: {
        ...
        sampling: {
            ...
            properties: {
                tools: {
                    additionalProperties: true,
                    description: 'Present if the client supports tool calling within sampling requests. When declared, the server can include tools and toolChoice parameters in sampling/createMessage requests.',
                    properties: {},
                    type: 'object'
                }
            },
