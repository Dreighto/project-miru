...
export const modelPreferences = {
    ...
    properties: {
        costPriority: {
            description: 'How much to prioritize cost when selecting a model. A value of 0 means cost is not important, while a value of 1 means cost is the most important factor.',
            maximum: 1,
            minimum: 0,
            type: 'number'
        },
        ...
        intelligencePriority: {
            description: 'How much to prioritize intelligence and capabilities when selecting a model. A value of 0 means intelligence is not important, while a value of 1 means intelligence is the most important factor.',
            maximum: 1,
            minimum: 0,
            type: 'number'
        },
        speedPriority: {
            description: 'How much to prioritize sampling speed (latency) when selecting a model. A value of 0 means speed is not important, while a value of 1 means speed is the most important factor.',
            maximum: 1,
            minimum: 0,
            type: 'number'
        }
...
export const toolChoice = {
    description: 'Controls how the model should use the provided tools. Can be "auto" (model decides), "required" (must use a tool), or specify a particular tool.',
    anyOf: [
        {
            properties: {
                type: {
            ...
            properties: {
                ...
                params: {
                    properties: {
                        ...
                        toolChoice: {
                            ...toolChoice,
                            description: 'Controls how the model should use the provided tools. Only valid if the client declares the sampling.tools capability.'
                        },
                        tools: {
                            description: 'An array of tools that the model can call during sampling. Only valid if the client declares the sampling.tools capability. The client MUST return an error if this field is provided but the capability is not declared.',
                            items: tool,
                            type: 'array'
                        }
                    },
