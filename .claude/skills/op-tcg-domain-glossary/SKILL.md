---
name: op-tcg-domain-glossary
description: One Piece TCG terminology — set codes, card types, attributes, values, colors, rarities, print conventions, mechanics shorthand. Use when discussing or implementing anything touching OP TCG cards (catalog work, storefront tiles, image-asset pipeline, AI training corpus, deck design). Triggers include One Piece, OP TCG, card number, print_id, rarity, leader, character, event, stage, OP01, ST01, PRB01, Bandai, _pN, _r1, _r2, alt-art, Romance Dawn, set code, life value, DON, counter value.
---
