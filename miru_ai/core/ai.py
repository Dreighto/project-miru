...
from miru_ai.core.ai_onepiece import load_onepiece_knowledge
...
def infer_file_hints(request_text: str) -> list[str]:
    ...
    explicit_files = (
        ...
        "miru_ai/core/ai.py",
        "miru_ai/server.py",
        "miru_ai/static/miru_ai.js",
        "miru_ai/templates/miru_ai.html",
    )
...
def build_local_codex_prompt(request_text: str, understanding: dict) -> str:
    ...
    output_lines = [
        ...
        "Files likely involved",
        format_prompt_units(
            split_prompt_units("\n".join(infer_file_hints(request_text) or ["pm/app.py", "miru_ai/core/ai_onepiece.py", "miru_ai/core/ai.py"])),
            max_units=4,
            bullet=True,
        ),
        "",
