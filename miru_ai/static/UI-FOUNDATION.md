...
This document describes the layered styling structure and conventions for the Miru AI surface (port 18765). The worktree Project Miru dashboard (port 18080) uses its own inline styles in `pm/app.py` and is out of scope for this file.
...
- Dashboard (18080) uses inline CSS in `pm/app.py`; no shared token/primitive system there yet.
