...
- Schema changes: propose to Claude Code first, operator approves before execution
...
- Check git status before starting; stop and report if another worker owns the target file
